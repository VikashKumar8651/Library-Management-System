	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			ResultSet rs = vs.executeQuery();  
			 out.println("<button><a href='exportexcel?BOOK_STATISTICS_fOR_ALL_BRANCH_Selct_Category=%5BSELECT%5D&BOOK_STATISTICS_fOR_ALL_BRANCH_Department=IT&BOOK_STATISTICS_fOR_ALL_BRANCH_ACCESSNUMBER=51&BOOK_STATISTICS_fOR_ALL_BRANCH_tittle=&BOOK_STATISTICS_fOR_ALL_BRANCH_author=&BOOK_STATISTICS_fOR_ALL_BRANCH_Publisher=&BOOK_STATISTICS_fOR_ALL_BRANCH_Edition='>export excel</a></button>");
